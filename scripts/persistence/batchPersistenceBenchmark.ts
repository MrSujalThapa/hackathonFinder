#!/usr/bin/env node
/**
 * C1 audit tool — batch persistence metrics / optional write experiment.
 * Not a production runtime path. Production always uses BatchPersistenceStrategy
 * via selectPersistenceStrategyFromEnv() (batch default).
 */
