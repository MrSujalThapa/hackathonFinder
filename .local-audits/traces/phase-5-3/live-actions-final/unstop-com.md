...
| 2 | network_json | `data.data` | 28 | 1 | 0.55 | 0.753 | filter/facet-like array; sponsor-only array |
| 3 | network_json | `data[3].sub_categories` | 10 | 1 | 0.55 | 0.753 |  |
