...
## Summary
    ...
    [structured-v2] Generic structured extraction
      ...
      AI rejected reasons       OpenAI HTTP 400: Invalid schema for response_format 'ai_page_decision': In context=('properties', 'fields'), 'required' is required to be supplied and to be an array including every key in properties. Missing 'title'.
