...
## Summary
    ...
    [structured-v2] Generic structured extraction
      ...
      AI latency                1.6s
      AI rejected reasons       classification: Invalid enum value. Expected 'event_records' | 'navigation' | 'editorial' | 'forms' | 'sponsors' | 'uncertain', received 'dom'; : Unrecognized key(s) in object: 'recordCount'
