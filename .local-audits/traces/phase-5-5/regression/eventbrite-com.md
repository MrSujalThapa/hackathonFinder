...
## Summary
    ...
    [structured-v2] Generic structured extraction
      ...
      actions discovered        11
      actions executed          0
      listeners before nav       yes
      browser final rendered URL https://www.eventbrite.com/d/online/hackathon/
      DOM samples                after-domcontentloaded:2790/6026/115, stability-1:2930/6226/115, stability-2:2930/6226/115, stability-1:3063/6466/115, stability-2:3063/6466/115, stability-1:3095/6508/115, stability-2:3095/6508/115
      network JSON responses     2
      nested scroll containers   0
      iframes/open shadows       0/0
      loading overlay            no
      action trace              action:86/load_more/rejected/+3(page fingerprint did not change); action:104/load_more/rejected/+3(page fingerprint did not change)
      checkpoint loaded         no
      checkpoint saved          no
      browser pages             1
      bytes inspected           3125816
      arrays scanned            49
...
| 5 | html:0 | 492 | 10 | 0.805 | 1 | 1 | 0 |  |
| 6 | dom_snapshot:9 | 493 | 10 | 0.805 | 1 | 1 | 0 |  |
| 7 | dom_snapshot:10 | 493 | 10 | 0.805 | 1 | 1 | 0 |  |
| 8 | dom_snapshot:11 | 493 | 10 | 0.805 | 1 | 1 | 0 |  |
| 9 | html:0 | 47 | 4 | 0.8 | 1 | 1 | 0 |  |
| 10 | html:0 | 65 | 5 | 0.8 | 1 | 1 | 0 |  |
| 11 | html:0 | 86 | 6 | 0.8 | 1 | 1 | 0 |  |
| 12 | html:0 | 110 | 4 | 0.8 | 1 | 1 | 0 |  |
...
```json
{
  ...
  "estimatedAvailableRecords": 800,
  "estimatedRecall": 0.005,
  "degradedReasons": [
